...
async def get_weather_2(message: types.Message):
    try:
        ...
        # sec_message = await bot.send_message(message.from_user.id, '<b>Секундочку...</b>', parse_mode=ParseMode.HTML)

        # file_to_send = InputFile(f'data//photos//second_please.jpg')
        ...
        sec_message = await bot.send_photo(message.from_user.id, photo=file_to_send_id, caption='<b>Секундочку...</b>', parse_mode=ParseMode.HTML)
        # sec_message = await bot.send_media_group(message.from_user.id, media=media, caption='<b>Секундочку...</b>', parse_mode=ParseMode.HTML)
        ...
        # await bot.send_photo(message.from_user.id, photo=media, caption=f'<b>А вот и погода подъехала!</b>', parse_mode=ParseMode.HTML)
